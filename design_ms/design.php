...
$fellow_count = 0;
//取得指定管理人數
$pjmyfellow_row = getkeyvalue2($site_db."_info","pjmyfellow","web_id = '$web_id' and project_id = '$project_id' and auth_id = '$auth_id' and pro_id = 'design'","count(*) as fellow_count");
...
$pjItemManager = false;
//檢查是否為指定管理人
$pjmyfellow_row = getkeyvalue2($site_db."_info","pjmyfellow","web_id = '$web_id' and project_id = '$project_id' and auth_id = '$auth_id' and pro_id = 'design' and member_no = '$memberID'","count(*) as enable_count");
...
<script type="text/javascript" charset="utf-8">
	...
	$(document).ready(function() {
		...
		$('#db_table').dataTable( {
			...
			"ordering": false,
			"ajaxSource": "/smarty/templates/$site_db/$templates/sub_modal/project/func02/design_ms/server_design.php?site_db=$site_db&fm=$fm",
			"language": {
						"sUrl": "$dataTable_de"
			...
			"fnRowCallback": function( nRow, aData, iDisplayIndex ) { 
				...
				*/
				...
				//最後修改
				var last_modify5 = (aData[13] != null && aData[13] != "") 
					? '<div class="text-nowrap">' + moment(aData[13]).format('YYYY-MM-DD HH:mm') + '</div>' 
					: "";

				
				//編輯人員
				var member_name = (aData[15] != null && aData[15] != "") 
					? '<span class="text-nowrap">' + aData[15] + '</span>' 
					: "";

				var update_count_val = (aData[24] != null && aData[24] != "") ? aData[24] : "0";

				if ((last_modify5 == null || last_modify5 == "") && (member_name == null || member_name == "")) {
				
				$('td:eq(18)', nRow).html('<div style="height:auto;min-height:32px;"></div>');
